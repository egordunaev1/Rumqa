  ...
  render() {
    return (
      <div className="container">
        ...
        {this.props.owner.id === this.props.user.id && this.props.user.profile.incoming_friend_requests.length ?
          <div>
            ...
            {this.props.user.profile.incoming_friend_requests.map((friend, ind) => (
              <div key={ind + '1'} className="friend pt-2">
                <div key={ind + '2'} className="media">
                  <Link key={ind + '3'} to={'/profile/' + friend.id} onClick={() => this.props.getUser()}><img key={ind + '4'} src={"http://localhost:8000" + friend.profile.cover} alt="" className="mr-3 rounded-max" width="80px" height="80px" /></Link>
            ...
            {this.state.search_results.map((result, ind) => (
              <div key={ind + 'f'} className="friend pt-2">
                <div key={ind + 'm'} className="media">
                  <Link key={ind + 'l'} to={'/profile/' + result.id}><img src={"http://localhost:8000" + result.profile.cover} alt="" className="mr-3 rounded-max" width="80px" height="80px" /></Link>
